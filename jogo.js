var erros = 0;
var listaCartas = ["pug", "spitz", "salsicha", "beagle", "viralata", "golden", 
"shihtzu", "maltipoo", "pincher", "viralatatambem"]
...
if (this.src.includes("varioscachorros")){
...
function atualizar() {
    ...
    if (carta1selecionada.src != carta2selecionada.src) {
        carta1selecionada.src = "varioscachorros.png";
        carta2selecionada.src = "varioscachorros.png";
        erros += 1;
